...
/**
 * createObjectURL은 메모리에 객체 URL 생성하기 떄문에
 * revokeObjectURL을 호출하여 기존 객체 URL을 제거해야 메모리 누수를 방지할 수 있음
 * fileValue가 변경될 때마다 (파일을 업로드할 때마다) cleanup 함수를 호출하여 기존 객체 URL을 제거하도록 함
 */
